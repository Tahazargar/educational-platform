    ...
    <div class="container">
        ...
        <div class="row g-4">
            ...
            <div class="col-lg-3">
                ...
                <p class="mb-2">
                    تلفن:
                    <span class="h6 fw-light ms-2">093200000000</span>
            ...
            <div class="container px-0">
                <div class="d-lg-flex justify-content-between align-items-center py-3 text-center text-md-left">
                    ...
                    <div class="text-primary-hover">
                        ارائه شده در سایت
                        <a href="https://www.rtl-theme.com/" target="_blank" class="text-body">
                            راست چین
                        </a>
                    </div>
                                ...
                                <div class="dropup mt-0 text-center text-sm-end">
                                    ...
                                    <ul class="dropdown-menu min-w-auto">
                                        <li>
                                            <a class="dropdown-item me-4" href="#">
                                                <img class="fa-fw me-2"
                                                     src="{{ Vite::asset('resources/assets/images/flags/uk.svg') }}"
                                                     alt="">
                                                فارسی
                                            </a>
                                        </li>
                                        <li>
                                            <a class="dropdown-item me-4" href="#">
                                                <img class="fa-fw me-2"
                                                     src="{{ Vite::asset('resources/assets/images/flags/gr.svg') }}"
                                                     alt="">
                                                انگلیسی
                                            </a>
                                        </li>
                                        <li>
                                            <a class="dropdown-item me-4" href="#">
                                                <img class="fa-fw me-2"
                                                     src="{{ Vite::asset('resources/assets/images/flags/sp.svg') }}"
                                                     alt="">
                                                فرانسوی
                                            </a>
                                        </li>
