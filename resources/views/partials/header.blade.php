            ...
            <div class="navbar-collapse w-100 collapse " id="navbarCollapse">
                ...
                <ul class="navbar-nav navbar-nav-scroll me-auto">
                    ...
                    <li class="nav-item dropdown">
                        <a class="nav-link  active fs-6 fw-bold" href="#" id="demoMenu"  aria-haspopup="true" >خانه</a>
                    </li>

                    <!-- Nav item 2 Pages -->
                    <li class="nav-item dropdown dropdown-fullwidth">
                        <a class="nav-link dropdown-toggle fs-6 " href="#" data-bs-toggle="dropdown" aria-haspopup="true" aria-expanded="false">دوره های آموزشی</a>
                    ...
                    <!-- Nav item 3 Megamenu-->
                    <li class="nav-item ">
                        <a class="nav-link fs-6" href="#" id="pagesMenu" >وبلاگ</a>
